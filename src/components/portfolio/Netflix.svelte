...
<article class="card">
	...
	<div id="cover" class="drop-shadow">
		...
		<p>
			During our first project with Netflix, for a movie set in Boston, I suggested and prototyped a
			parody of Google Translate, called <b>Netflix Translate</b>.
		</p>
		<p>
			It had the look of Google's famous translation tool, but would convert to the city's slang.
		</p>
	</div>
</article>
